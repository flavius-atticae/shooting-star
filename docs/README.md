...
Welcome to the Shooting Star project documentation. This hub provides supporting information for developing and maintaining Pauline Roussel's perinatal yoga and motherhood wellness website.
...
**Shooting Star** is a React Router v7 application for a yoga instructor specializing in perinatal yoga, motherhood wellness, and birth accompaniment.  
The site uses a modern, accessible frontend stack:
...
For a complete, up‑to‑date overview of the project, always refer to the root [`README.md`](../README.md).
