...
export default function DoulaPage() {
  ...
  // Services items for "À la carte" section
  const doulaServices: ServiceItem[] = [
    ...
    },
    {
      ...
      description:
        "Rencontre personnalisée pour répondre à vos questions, écouter et se guider selon son parcours et ses besoins spécifiques, et préparer quel moment de la maternité.",
      buttonText: "En savoir plus",
