...
const HomePage = () => (
  <div data-testid="home-page">
    ...
    <nav>
      <a href="/cours" data-testid="cours-link">
        Cours de Yoga Prénatal
      </a>
      <a href="/ressources" data-testid="ressources-link">
        Ressources
      </a>
  ...
  <div data-testid="cours-page">
    <header>
      ...
      <nav aria-label="Navigation des trimestres">
        <a href="/cours/premier-trimestre" data-testid="t1-link">
          Premier Trimestre
        </a>
        <a href="/cours/deuxieme-trimestre" data-testid="t2-link">
          Deuxième Trimestre
        </a>
        <a href="/cours/troisieme-trimestre" data-testid="t3-link">
          Troisième Trimestre
        </a>
      </nav>
    </header>
    <main>
      <section>
        ...
        <p>
          Nos cours de yoga prénatal sont spécialement conçus pour chaque trimestre de grossesse.
        </p>
      </section>
      <Outlet />
    </main>
  ...
  <div data-testid={`trimester-${trimester}-page`}>
    <header>
      <nav aria-label="Fil d'Ariane">
        ...
        {trimester === "1" ? "Premier" : trimester === "2" ? "Deuxième" : "Troisième"} Trimestre
      </nav>
      <h1>
        Yoga - {trimester === "1" ? "Premier" : trimester === "2" ? "Deuxième" : "Troisième"}{" "}
        Trimestre
      </h1>
    </header>
    <main>
      <section>
        ...
        <section aria-labelledby="description-title">
          ...
          <p>
            Cours spécialisé pour le{" "}
            {trimester === "1" ? "premier" : trimester === "2" ? "deuxième" : "troisième"}{" "}
            trimestre, avec des postures adaptées aux changements de votre corps.
          </p>
        </section>
        ...
        <div data-testid={`trimester-${trimester}-page`}>
          <form data-testid="booking-form" onSubmit={handleSubmit}>
            ...
            <input
              ...
              style={{ minHeight: "44px", padding: "12px" }}
            />
            <button type="submit" style={{ minHeight: "48px", padding: "12px 24px" }}>
              Réserver ma place
            </button>
          </form>
        </div>
