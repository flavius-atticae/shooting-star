...
describe("Container Component - Pregnancy-Safe Testing", () => {
  ...
  describe("French Content Support", () => {
    it("should handle French text without layout issues", () => {
      const frenchContent =
        "Découvrez nos cours de yoga prénatal adaptés à chaque trimestre de votre grossesse. Nos séances sont conçues pour votre bien-être et celui de votre bébé.";
