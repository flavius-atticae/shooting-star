 ...
 * - Typography The Seasons pour titre + Barlow pour contenu
    ...
    >
      ...
      <div className="lg:col-span-1">
        ...
        >
          ...
          <div 
            id="image-placeholder-description" 
            className="sr-only"
          >
            Emplacement réservé pour la photo de Pauline Roussel, instructrice de yoga périnatal et doula. Photo prochainement disponible.
          </div>
        </figure>
      </div>
    </div>
